...
class ActivityCountry : AppCompatActivity() {
            ...
            override fun onResponse(call: Call, response: Response) {
                response.body?.let { responseBody ->
                    ...
                    runOnUiThread{
                        ...
                        rvCountries.layoutManager = LinearLayoutManager(this@ActivityCountry)

                        val adapter = CountryAdapter(countriesList)
                        rvCountries.adapter = adapter

                        adapter.setOnItemClickListener { country ->
                            val intent = Intent(this@ActivityCountry, ContryDetailActivity::class.java)
