...
class ContryDetailActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_contry_detail)
        ...
        val txtCountryOfficialName : TextView= findViewById(R.id.countryOffcialName)
